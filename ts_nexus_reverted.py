...
try:
    from nexus_config import (
        TS_CLIENT_ID, TS_CLIENT_SECRET, TS_ACCOUNT_ID, TS_REFRESH_TOKEN,
        DISCORD_WEBHOOK_URL, DRY_RUN_EXEC
    )
except ImportError:
    TS_CLIENT_ID = None; TS_CLIENT_SECRET = None; TS_ACCOUNT_ID = None; TS_REFRESH_TOKEN = None;
    DISCORD_WEBHOOK_URL = None; DRY_RUN_EXEC = True
            ...
            try:
                ...
                if DRY_RUN_EXEC:
                    ...
                    if is_option:
                        ...
                        elif action == "SELL": ts_action = "SellToClose" # Assumption: We only close longs. 
                                                                         # If shorting, need "SellToOpen".
                                                                         # Current Logic: Simple Long Only Strategy?
                        # ERROR CORRECTION: If we are selling to open (short), this fails.
                        # But typically we buy calls/puts.
